...
// Vendored under node_modules (not some arbitrary "vendor/" folder) so
// Vercel's Node.js Functions builder leaves it alone as pre-built content -
// see vercel-build.js's vendoring step for the full explanation.
const VENDORED_ENTRY = path.resolve(__dirname, '../../node_modules/@katalyst/ai-client-vendor/dist/index.js');
